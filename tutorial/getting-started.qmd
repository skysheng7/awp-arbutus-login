...
**Users with linux-64, osx-64, or osx-arm64 operating systems: use conda-lock (recommended):**
```bash
conda-lock install -n arbutus conda-lock.yml
```

**Users with other operating systems (e.g., win-64): use environment.yml directly:**
```bash
